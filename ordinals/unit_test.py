...
class TestToken:
    ...
    def test_get_top_20_holder(self):
        ...
        assert type(ordi.top_20_holders_df) == pd.DataFrame
        assert ordi.top_20_holders_df.shape == (20, 5)
        assert ordi.top_20_holders_df.columns.tolist() == [
            "tick",
            "address",
            "overall_balance",
        ...
        assert ordi.top_20_holders_df.iloc[-1]["overall_balance"] > 0
        
        eight = Token("8888", False)
        eight.get_top_20_holders()
        assert type(eight.top_20_holders_df) == pd.DataFrame
        assert eight.top_20_holders_df.shape == (20, 5)
        assert eight.top_20_holders_df.columns.tolist() == [
            "tick",
            "address",
            "overall_balance",
            "transferable_balance",
        ...
        assert eight.top_20_holders_df.iloc[-1]["overall_balance"] > 0
